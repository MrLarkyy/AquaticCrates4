...
@Serializable
data class ModelEngineRewardShowcaseData(
    ...
    companion object {
        fun TypedNestedSchemaBuilder<ModelEngineRewardShowcaseData>.defineEditor() {
            field(
                ModelEngineRewardShowcaseData::modelId,
                TextFieldAdapter,
                TextFieldConfig(
                    prompt = "Enter ModelEngine showcase model id:",
                    validator = CrateDataValidators::validateModelEngineModel
                ),
                displayName = "Model ID",
                iconMaterial = Material.ARMOR_STAND,
                description = listOf("ModelEngine model id used for this reward showcase.")
            )
            field(
                ModelEngineRewardShowcaseData::viewRange,
                IntFieldAdapter,
            ...
            field(
                ModelEngineRewardShowcaseData::scale,
                displayName = "Scale",
                prompt = "Enter ModelEngine showcase scale:",
                iconMaterial = Material.SLIME_BALL,
                description = listOf("Base scale applied to the ModelEngine showcase.")
            )
            field(
                ModelEngineRewardShowcaseData::displayNameYOffset,
            ...
            field(
                ModelEngineRewardShowcaseData::glowing,
                displayName = "Glowing",
                prompt = "Enter true or false:",
                iconMaterial = Material.GLOW_INK_SAC,
                description = listOf("If enabled, the ModelEngine showcase always renders with glow.")
            )
            field(
                ModelEngineRewardShowcaseData::glowColor,
                adapter = GlowColorFieldAdapter,
                displayName = "Glow Color",
                iconMaterial = Material.ORANGE_DYE,
                description = listOf("MC glow color used while the ModelEngine showcase is glowing.")
            )
        }
    }
}
